        ...
        <div class="sm:text-center lg:text-left">
          ...
          <div class="mt-5 sm:mt-8 md:mt-20 sm:flex sm:justify-center lg:justify-start">
            <div class="">
              <a
                href="#contact"
                class="rounded-md shadow w-full flex items-center justify-center px-8 py-3 border-2 border-transparent text-base
                font-medium text-white
                bg-brand-green-700 hover:bg-brand-green-700
            ...
            <div class="mt-3 sm:mt-0 sm:ml-6">
              <a
                ...
                class="w-full flex items-center justify-center px-8 py-3
                   text-base font-medium rounded-md text-brand-green-700 border-2 border-brand-green-700
                  bg-brand-grseen-100 hover:bg-brand-green-100 md:py-4 md:text-lg md:px-10">
                Our Services
              </a>
            </div>
          </div>
