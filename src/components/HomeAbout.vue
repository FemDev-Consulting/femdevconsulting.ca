<template>
  <div class="relative overflow-hidden z-20">
    <div class="container flex flex-row-reverse">
      <div class="w-full lg:w-2/5 py-40 md:py-52 lg:py-52 lg:ml-10 xl:ml-40">
        <div class="sm:text-center lg:text-left">
          <h1 class="tracking-normal font-extrabold text-brand-green-800 text-4xl sm:text-5xl md:text-6xl xl:text-5xl">
            About us
          </h1>
          <p class="mt-6 text-2xl  text-gray-600  leading-relaxed max-w-prose">
    ...
    <div class="hidden absolute bottom-0 top-0 left-0 lg:flex items-center w-1/2" style="z-index: -1;">
      <svg
        class="transform rotate-45 scale-105 xl:scale-105 -translate-x-1/3 2xl:-translate-x-1/2 w-full fill-current text-brand-pink-600"
        viewBox="0 0 200 200"
